package com.ai.friday.starredpersons
...
class StarredPersonAdapter(private val itemClickListener: ItemClickListener) :
    RecyclerView.Adapter<StarredPersonAdapter.PersonViewHolder>() {
